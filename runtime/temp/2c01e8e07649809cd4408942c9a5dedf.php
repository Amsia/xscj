<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\wamp64\www\xscj\public/../application/index\view\dean\dean.html";i:1578039539;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
...
<div class="layui-tab" lay-filter="demo">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item  layui-show">
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td><a class="layui-btn layui-btn-xs" href="changePWD.do?id=<?php echo $dean['deanId']; ?>">更改密码</a>
                        <a class="layui-btn layui-btn-xs" href="logout.do">注销账号</a>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="layui-tab-item " >
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <a href="insertStudent.do" class="layui-btn">添加一名学生</a>
                </div>
            </div>
            <br><hr>
            <div class="layui-input-block">
                <a href="index.jsp" class="layui-btn">注销账号</a>
            </div>
        ...
        <div class="layui-tab-item">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <a href="insertTeacher.do" class="layui-btn">添加一名教师</a>
                </div>
            </div>
        ...
        <div class="layui-tab-item">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <a href="insertOnCourse.do" class="layui-btn">开启一门课程</a>
                    <a href="insertCourse.do" class="layui-btn">添加一门课程</a>
                </div>
            </div>
        </div>
        <!-- 			成绩管理------------------------------------------- -->
