<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wamp64\www\xscj\public/../application/index\view\Dean\insertOnCourse.html";i:1578210857;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<br>
<form class="layui-form" action="<?php echo url('dean/doInsertOnCourse'); ?>" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-inline">
                <input type="text" id="date1" name="examTime" placeholder="请输入考试时间" autocomplete="off"
                       class="layui-input" >
            </div>
            <label class="layui-inline">截至日期</label>
            <div class="layui-inline">
                <input type="text" id="date2" name="deadline" placeholder="请输入截至录入时间" autocomplete="off"
                       class="layui-input" >
            </div>
        </div>
        <div class="layui-inline layui-word-aux">格式为: 2019-7-3</div>
    </div>
    <div class="layui-form-item">
