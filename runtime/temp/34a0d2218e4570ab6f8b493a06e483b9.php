<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\wamp64\www\xscj\public/../application/index\view\dean\updateClass.html";i:1578214230;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<form class="layui-form" action="<?php echo url('dean/doUpdateClass'); ?>" method="post" style="width: 420px;margin: 20px auto;">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <a href="<?php echo url('Dean/findClass'); ?>">
